...
class GenericThermostat(ClimateEntity, RestoreEntity):
    ...
    async def async_added_to_hass(self) -> None:
        ...
        self.async_on_remove(
            async_track_state_change_event(self.hass, [self.sensor_entity_id], self._async_sensor_changed)
        )
        self.async_on_remove(
            async_track_state_change_event(self.hass, [self.heater_entity_id], self._async_switch_changed)
        )
        ...
        if (old_state := await self.async_get_last_state()) is not None:
            ...
            if self._target_temp is None:
                self._target_temp = self.max_temp if self.ac_mode else self.min_temp
